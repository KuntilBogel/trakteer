...
class Trakteer {
    ...
    /**
     * Send Donation
     * @param {Number} amountToDonate - Amount to donate, Ex: 2
     ...
     */
    async sendDono(amountToDonate, message, display_name, email_address) {
        ...
        return new Promise(async (resolve, reject) => {
            ...
            amountToDonate = Number(amountToDonate)
            if (!amountToDonate || amountToDonate < 1) reject("Error: (SendDono) AmountToDonate should be a number and more than 0")
            try {
